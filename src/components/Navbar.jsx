...
import { Sparkles, Coins, LogOut, User, LogIn, Menu, X, Scissors, Smile, Compass, Sparkle, Settings as SettingsIcon, CreditCard, BookOpen, Paintbrush, Gem, Globe, Sun, Moon } from 'lucide-react';
import { t, getLanguage, setLanguage } from '../utils/i18n';

export default function Navbar({ activeTab, setActiveTab, user, guestTokens, onLogout, onOpenAuth, theme, setTheme }) {
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', width: '100%' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'rgba(255,46,147,0.06)', borderRadius: '12px', padding: '0.6rem 1rem' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                      ...
                      <span style={{ fontSize: '0.9rem', fontWeight: 700, color: 'var(--color-pink-primary)', display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                        {user.tokens} {t('nav.credits')}
                      </span>
                    </div>
