    ...
    if (isTMA()) {
      ...
      try {
        const res = await authFetch('/api/telegram/create-invoice', {
          ...
          body: JSON.stringify({ planId: finalPlan.id })
        });
          ...
          {activePlans.map((plan) => {
            ...
            >
              ...
              <button 
                ...
                style={{ width: '100%', padding: '0.9rem 0', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem' }}
              >
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center', justifyContent: 'center', flexWrap: 'wrap', marginTop: '0.5rem' }}>
            <div style={{ background: '#ffffff', border: '1px solid rgba(0,0,0,0.08)', padding: '0.4rem 0.8rem', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', height: '36px', width: '80px', boxShadow: '0 2px 4px rgba(0,0,0,0.02)' }}>
              <img src="https://upload.wikimedia.org/wikipedia/commons/b/ba/Stripe_Logo%2C_revised_2016.svg" alt="Stripe" style={{ height: '18px', maxWidth: '100%', objectFit: 'contain' }} />
            </div>
            <div style={{ background: '#ffffff', border: '1px solid rgba(0,0,0,0.08)', padding: '0.4rem 0.8rem', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', height: '36px', width: '80px', boxShadow: '0 2px 4px rgba(0,0,0,0.02)' }}>
              <img src="https://upload.wikimedia.org/wikipedia/commons/5/5e/Visa_2021.svg" alt="Visa" style={{ height: '12px', maxWidth: '100%', objectFit: 'contain' }} />
            </div>
            <div style={{ background: '#ffffff', border: '1px solid rgba(0,0,0,0.08)', padding: '0.4rem 0.8rem', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', height: '36px', width: '80px', boxShadow: '0 2px 4px rgba(0,0,0,0.02)' }}>
              <img src="https://upload.wikimedia.org/wikipedia/commons/2/2a/Mastercard-logo.svg" alt="Mastercard" style={{ height: '20px', maxWidth: '100%', objectFit: 'contain' }} />
            </div>
            <div style={{ background: '#ffffff', border: '1px solid rgba(0,0,0,0.08)', padding: '0.4rem 0.8rem', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', height: '36px', width: '80px', boxShadow: '0 2px 4px rgba(0,0,0,0.02)' }}>
              <img src="https://upload.wikimedia.org/wikipedia/commons/f/f2/Google_Pay_Logo.svg" alt="Google Pay" style={{ height: '16px', maxWidth: '100%', objectFit: 'contain' }} />
            </div>
            <div style={{ background: '#ffffff', border: '1px solid rgba(0,0,0,0.08)', padding: '0.4rem 0.8rem', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', height: '36px', width: '80px', boxShadow: '0 2px 4px rgba(0,0,0,0.02)' }}>
              <img src="https://upload.wikimedia.org/wikipedia/commons/b/b0/Apple_Pay_logo.svg" alt="Apple Pay" style={{ height: '16px', maxWidth: '100%', objectFit: 'contain' }} />
            </div>
          </div>
        </div>
